...
apt-get install wget
 ...
 curl https://raw.githubusercontent.com/zdolson/Neo-Market/master/backend/Contracts/testme/test.py -o test.py
 curl https://raw.githubusercontent.com/zdolson/Neo-Market/master/backend/Contracts/testme/compile.py -o compile.py
